...
def get_normalization_layer(num_features: int,
                            ...
                            **kwargs):
    norm_type = opts_model_normalization_name if norm_type is None else norm_type
    num_groups = opts_model_normalization_groups if num_groups is None else num_groups
    momentum = opts_model_normalization_momentum
...
class AdjustBatchNormMomentum(object):
    ...
    def __init__(self, opts, ):
        ...
        if self.is_iteration_based:
            ...
            warnings.warn("Running {} for epoch-based methods. Not yet validation.".format(self.__class__.__name__))
